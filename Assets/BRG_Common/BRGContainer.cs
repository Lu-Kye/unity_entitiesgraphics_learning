...
namespace MyBRG
{
    public class BRGContainer : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            m_InstanceData = new GraphicsBuffer(
        ...
        private void PopulateInstanceDataBuffer()
        {
            ...
            m_BatchID = m_ThreadedBatchContext.AddBatch(metadata, m_InstanceData.bufferHandle);
        }

        /// <summary>
        ///  Typically, there are two tasks that the OnPerformCulling callback needs to perform:
        ///     1. Visibility culling to determine which of its instances are visible based on the BatchCullingContext parameter.
        ///     2. Output the actual draw commands to render those instances. To do this you write to the BatchCullingOutput parameter.
        /// </summary>
