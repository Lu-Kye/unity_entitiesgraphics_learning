    ...
    UNITY_GDRP_DDXDDY_ARGUMENT)
{
    ...
    {
#ifdef UNITY_GPU_DRIVEN_PIPELINE
        float lod = CalcLod(lightmapTex, transform.xy UNITY_GDRP_DDXDDY_PARAMETER);
    ...
    inout real3 bakeDiffuseLighting, inout real3 backBakeDiffuseLighting)
{
...
#ifdef UNITY_GPU_DRIVEN_PIPELINE
    float lod = CalcLod(lightmapDirTex, transform.xy UNITY_GDRP_DDXDDY_PARAMETER);
    ...
    {
#ifdef UNITY_GPU_DRIVEN_PIPELINE
        lod = CalcLod(lightmapTex, transform.xy UNITY_GDRP_DDXDDY_PARAMETER);
        real4 encodedIlluminance = SAMPLE_TEXTURE2D_LIGHTMAP(lightmapTex, lightmapSampler, LIGHTMAP_EXTRA_ARGS_USE, lod).rgba;
#else
        real4 encodedIlluminance = SAMPLE_TEXTURE2D_LIGHTMAP(lightmapTex, lightmapSampler, LIGHTMAP_EXTRA_ARGS_USE).rgba;
#endif
